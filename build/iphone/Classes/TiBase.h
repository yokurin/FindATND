...
// in simulator we redefine to format for FindATND Developer console
...
{\
	NSString * exceptionName = [@"org.findatnd." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.findatnd";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIFindATNDNativeItemNone = -1, 
	UIFindATNDNativeItemSpinner = -2,
	UIFindATNDNativeItemProgressBar = -3,
	
	UIFindATNDNativeItemSlider = -4,
	UIFindATNDNativeItemSwitch = -5,
	UIFindATNDNativeItemMultiButton = -6,
	UIFindATNDNativeItemSegmented = -7,
	
	UIFindATNDNativeItemTextView = -8,
	UIFindATNDNativeItemTextField = -9,
	UIFindATNDNativeItemSearchBar = -10,
	
	UIFindATNDNativeItemPicker = -11,
	UIFindATNDNativeItemDatePicker = -12,
	
	UIFindATNDNativeItemInfoLight = -13,
	UIFindATNDNativeItemInfoDark = -14,
	
	UIFindATNDNativeItemDisclosure = -15,
	
	UIFindATNDNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all FindATND instances of
