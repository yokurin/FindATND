...
//@interface FindATNDObject : NSObject
//@end

@interface FindATNDObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FindATNDObject class]])
		{
			for (NSString *key in [[(FindATNDObject*)o modules] allKeys])
			{
